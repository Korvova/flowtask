...
<body>
    ...
    <script src="components/StatusColors.js?v=1761645295"></script>
    <script src="components/PullSubscription.js?v=1761645295"></script>
    <script src="components/TaskCreator.js?v=1761645295"></script>
    <script src="components/TaskNode.js?v=1761645295"></script>
    <script src="components/TaskModal.js?v=1761645295"></script>
    <script src="components/FlowCanvas.js?v=1761645295"></script>
    ...
    <script>
        ...
        BX24.init(function() {
            ...
            console.log('%c🚀 FLOWTASK ЗАГРУЖЕН! Версия: v=1761645295', 'color: #00ff00; font-size: 20px; font-weight: bold;');
            console.log('%c═══════════════════════════════════════════', 'color: #00ff00; font-size: 16px;');
